          ...
          console.log(data.results);
            for (var i = 0; i < data.results.length; i++) {
              ...
              tickers.push(data.results[i].ticker)
                ...
                for (j=0; j< tickersList.length; j++) {
                  document.writeln(items[j])
               }
                  /*for (var j = 0; j < tickersList.length; j++) {
                    ...
                    //link.textContent = tickersList;
                    //link.href = tickersList;
            
                    // Appending the link to the tabledata and then appending the tabledata to the tablerow
                    // The tablerow then gets appended to the tablebody
                    //tableData.appendChild(link);
                    /*for(var k = 0; k < link.length; k++) {
                      //tableData.replaceChild(link[k], link[k-1]);
                      tableData.addChild(link[k]);
                      createTableRow.appendChild(tableData);
                      tableBody.appendChild(createTableRow);
                    }*/
                    /*tableData.insertRow(link);
                    createTableRow.appendChild(tableData);
                    tableBody.appendChild(createTableRow);
                  }*/
            }
